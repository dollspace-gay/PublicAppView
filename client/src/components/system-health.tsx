      ...
      <CardContent className="p-6 space-y-4">
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-semibold text-foreground font-mono" data-testid="text-cpu">{cpu}%</span>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-semibold text-foreground font-mono" data-testid="text-memory">{memory}%</span>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-semibold text-foreground font-mono" data-testid="text-disk">{disk}%</span>
          </div>
