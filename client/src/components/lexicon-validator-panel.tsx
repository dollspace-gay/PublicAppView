...
export function LexiconValidatorPanel({
  total,
  valid,
  invalid,
  errorRate,
}: LexiconValidatorProps) {
      ...
      <Card className="border-border" data-testid="card-supported-lexicons">
        <CardHeader className="border-b border-border">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Core app.bsky.* schemas ({lexicons.length} total)
          </p>
        </CardHeader>
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              {lexicons.map((lexicon) => (
                <div
                  key={lexicon.name}
                  className="flex items-center justify-between p-4 bg-muted rounded-lg transition-colors hover:bg-muted/80"
                >
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                ...
                data-testid="text-total-validated"
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                ...
                data-testid="text-valid-records"
              >
                {valid.toLocaleString()}
              </span>
            </div>
            <Progress
              value={total > 0 ? (valid / total) * 100 : 0}
              className="h-2"
            />
            <p className="text-xs text-muted-foreground mt-1">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                ...
                data-testid="text-invalid-records"
              >
                {invalid.toLocaleString()}
              </span>
            </div>
            <Progress
              value={total > 0 ? (invalid / total) * 100 : 0}
